...
import main.HyponymsHandler; // <- your HyponymsHandler is in the 'main' package
import demo.DummyHistoryHandler;
import demo.DummyHistoryTextHandler;

// import org.slf4j.LoggerFactory; // Commented out unless you need it
...
public class Main {
    ...
    static {
        // Optional: comment this out if LoggerFactory causes issues
